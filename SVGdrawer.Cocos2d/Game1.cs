...
namespace LvLEditor.Windows
{
    ...
    /// </summary>
     class Game1 : Game
    {
        private readonly GraphicsDeviceManager2 graphics;

        private readonly DrawingPanelControl control;


        public Game1(DrawingPanelControl ctr)
        {

            control = ctr;

            graphics = new GraphicsDeviceManager2(control);
            //#if MACOS

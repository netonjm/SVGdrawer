...
namespace LvLEditor.Windows
{
    ...
    /// </summary>
    public class DrawingPanelControl : GraphicsDeviceControl
    {
        BasicEffect effect;
        Stopwatch timer;
        ...
        protected override void Draw()
        {
            ...
            GraphicsDevice.DrawUserPrimitives(PrimitiveType.TriangleStrip,
                                            Vertices, 0, 1);
            RenderTarget2D tmp = new RenderTarget2D(GraphicsDevice, 300, 200);

            
            
           // ContentManager tmp = new ContentManager()

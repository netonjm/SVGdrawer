...
{
    public class GraphicsDeviceManager2 : IGraphicsDeviceService, IDisposable, IGraphicsDeviceManager
    {
        private DrawingPanelControl _game;
        ...
        public GraphicsDeviceManager2(DrawingPanelControl game)
        {
            if (game == null)
        ...
        private void Initialize()
        {
           ...
           // _game.Window.SetSupportedOrientations(_supportedOrientations);
...
#else
            presentationParameters.DeviceWindowHandle = _game.Handle;
#endif
            ...
            _graphicsDevice = new GraphicsDevice(null,   GraphicsProfile, presentationParameters);
        ...
        //        if (_game != null)
        //            _game.SetSupportedOrientations(_supportedOrientations);
        //    }
        //}

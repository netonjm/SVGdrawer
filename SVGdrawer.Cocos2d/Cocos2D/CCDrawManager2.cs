...
namespace Cocos2D
{
    ...
    public static class CCDrawManager2
    {
        ...
        private static GraphicsDeviceManager2 m_GraphicsDeviceMgr;

        private static void UpdatePresentationParametrs(GraphicsDeviceManager2 manager)
        {
        ...
        public static void InitializeDisplay(Game game, GraphicsDeviceManager2 graphics)
        {
        ...
        public static void Init(IGraphicsDeviceService service)
        {
            ...
            var manager = service as GraphicsDeviceManager2;
        ...
        {
            CCDrawManager2.graphicsDevice = graphicsDevice;
        ...
        {
            //CCGraphicsResource.DisposeAllResources(); //TODO: DisposeAllResources
        ...
        public static void BeginDraw()
        {
            ...
            if (m_bNeedReinitResources)
            {
                ...
                //CCGraphicsResource.ReinitAllResources(); //TODO: ReinitAllResources
        ...
        public static void CreateRenderTarget(CCTexture2D pTexture, RenderTargetUsage usage)
        {
            ...
            pTexture.InitWithTexture((Texture2D)texture);
            //TODO: pTexture.InitWithTexture
            //Texture2D ttt = new Texture2D()
            ...
            where T2 : struct
        {
            ...
            {
                passes[i].Apply();
                //TODO: graphicsDevice.DrawIndexedPrimitives(PrimitiveType.TriangleList, 0, 0, vertexBuffer.VertexBuffer.VertexCount, start, count);
                graphicsDevice.DrawIndexedPrimitives(PrimitiveType.TriangleList, 0, 0, vertexBuffer.Count, start, count);
            }
        ...
        public static void DrawQuadsBuffer<T>(CCVertexBuffer<T> vertexBuffer, int start, int n) where T : struct, IVertexType
        {
            ...
            {
                passes[i].Apply();
                //TODO: graphicsDevice.DrawIndexedPrimitives(PrimitiveType.TriangleList, 0, 0, vertexBuffer.VertexBuffer.VertexCount, start * 6, n * 2);
                graphicsDevice.DrawIndexedPrimitives(PrimitiveType.TriangleList, 0, 0, vertexBuffer.Count, start * 6, n * 2);
            }
